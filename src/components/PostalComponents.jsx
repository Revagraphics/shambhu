...
const portals = [
  { id: 1, name: "Amazon", url: "https://www.amazon.in/", category: "E-Commerce", logo: amazon },
  { id: 2, name: "Flipkart", url: "https://www.flipkart.com/", category: "E-Commerce", logo: flipcart },
  { id: 3, name: "Nykaa", url: "https://www.nykaa.com/", category: "Fashion", logo: nyka },
  { id: 4, name: "boAt", url: "https://www.boat-lifestyle.com/", category: "Electronics", logo: boat },
  { id: 5, name: "Derma Co", url: "https://thedermaco.com/", category: "Health", logo: derma },
  { id: 6, name: "Jockey", url: "https://www.jockey.in/", category: "Fashion", logo: jockey },
  { id: 7, name: "Myntra", url: "https://www.myntra.com/", category: "Fashion", logo: myntra },
  { id: 8, name: "Shaving Company", url: "https://www.bombayshavingcompany.com/", category: "Health", logo: shaving },
];
...
/* ------------------------------------------------------------------ */
/* 1. PortalDirectory — banner + category filter + portal/logo cards  */
/* ------------------------------------------------------------------ */
      ...
      <div className="max-w-7xl mt-6 mx-auto px-6">
        ...
        >
          {filteredData.map((portal) => (
            ...
            >
              <a target="_blank" rel="noreferrer" href={portal.url}>
                <img
                  src={portal.logo}
                  alt={portal.name}
...
/* ------------------------------------------------------------------ */
/* 2. ProductRequestForm — URL check + details + customer modal       */
/* ------------------------------------------------------------------ */
