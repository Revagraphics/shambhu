...
const Home = () => {
  ...
  return (
    <>
      <Seo
        title="shambhu corporation - Home"
        description="Welcome to Shambhu Corporation, your trusted partner for global FMCG exports. We bridge supply and demand across international markets."
      />
            ...
            <div className="grid lg:grid-cols-2 gap-12 sm:gap-5 items-center">
              ...
              <div className="lg:order-1">
                ...
                <p className="mt-6 text-lg text-gray-600 max-w-xl">
                  ...
                  navigate international trade regulations to export top-tier
                  FMCG goods globally.
                </p>
                ...
                <div className="flex  gap-4 mt-10">
                  <button
                    ...
                    className="px-3 lg:px-8 py-2 lg:py-4 bg-[#ffac1c] text-white rounded-xl font-medium hover:bg-[#E0920F] transition"
                  >
                    Get Started
                  </button>
                  ...
                  <button
                    ...
                    className="px-3 lg:px-8 py-2 lg:py-4 border border-[#ffac1c] text-zinc-800 rounded-xl font-medium hover:bg-[#E0920F] hover:text-white transition"
                  >
                    Learn More
                  </button>
                </div>
                ...
                <div className="mt-14 sm:mt-8 inline-flex items-center gap-4 bg-white shadow-md rounded-full sm:px-3 sm:py-2 px-6 py-4">
                  <div>
                    <span className="text-yellow-500 sm:text-xl text-2xl">
                      ★
                    </span>
                  </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <h2 className="text-2xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6">
                  Global <span className="text-[#D98E2C]">Trade Made </span>{" "}
                  Simple
                </h2>

                <p className="text-lg text-gray-600 mb-10">
                  We simplify international commerce and postal operations
                  through expert logistics, regulatory compliance, and reliable
                  service networks.
                </p>
          ...
          <div className="max-w-[90vw] mx-auto px-6 lg:px-12">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <h2 className="text-2xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6">
                  Complete{" "}
                  <span className="text-[#D98E2C]">Trade & Postal </span>{" "}
                  Support
                </h2>

                <p className="text-lg text-gray-600 mb-10">
                  From FMCG export to postal operations, we provide
                  comprehensive solutions tailored to bridge supply and demand
                  globally.
                </p>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mb-20">
              ...
              <p className="text-slate-500 mt-5 max-w-2xl mx-auto text-sm">
                Trade facilitation, postal services, and logistics solutions
                built for connecting businesses and communities worldwide.
              </p>
            </div>
          ...
          <div className="max-w-[90vw] mx-auto px-6 lg:px-12 py-20">
            <div className="grid lg:grid-cols-2 gap-12 sm:gap-5 items-center">
              ...
              <div className="lg:order-1">
                ...
                <h1 className="text-2xl lg:text-7xl font-bold leading-tight text-gray-900">
                  Delivering Quality{" "}
                  <span className="text-[#E0920F]"> Beyond Borders</span>
                </h1>

                <p className="mt-6 text-lg text-gray-600 max-w-xl">
                  At Shambhu Corporation, we specialize in exporting premium
                  FMCG products to global destinations. From sourcing and
                  documentation to logistics and delivery, our end-to-end trade
                  solutions ensure reliability, efficiency, and long-term value
