...
const Trading = () => {
  ...
  return (
    <>
      <Seo
        title="Global Trading Services | Shambhu Corporation"
        description="Leverage Shambhu Corporation's expertise in international trade to expand your business reach and build strong global distribution networks."
      />
        ...
        <section className="relative py-28 lg:py-32 bg-[#0B1E33] overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 mt-8 text-center">
            ...
            <motion.div
              ...
              className="grid grid-cols-3 gap-6 max-w-xl mx-auto mt-1 border-t border-white/10 pt-8"
            >
              {stats.map((s) => (
                <div key={s.label}>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="mt-6 text-slate-600 leading-relaxed">
                  ...
                  international markets by establishing strong trade connections
                  across multiple countries. Our expertise in global commerce
                  enables smooth transactions, market penetration, and long-term
                  business expansion.
                </p>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <h2 className="mt-4 text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900">
                  Building Strong{" "}
                  <span className="text-[#D98E2C]">Global Distribution</span>{" "}
                  Networks
                </h2>

                <p className="mt-6 text-slate-600 leading-relaxed">
                  Our distribution-focused approach helps brands strengthen
                  their presence in domestic and international markets. We work
                  closely with manufacturers, wholesalers, retailers, and
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="mt-6 text-slate-600 leading-relaxed">
                  ...
                  distributors, government organizations, and corporate clients
                  worldwide.
                </p>
