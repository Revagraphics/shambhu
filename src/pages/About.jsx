...
const About = () => {
  ...
  return (
    <>
      <Seo
        title="About Us | Shambhu Corporation"
        description="Learn more about Shambhu Corporation, our history, vision, and expertise in global trade, import-export operations, and logistics."
      />
          ...
          <div className="relative max-w-7xl mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <button
                  onClick={() => navigate("/exporting")}
                  className="group mt-8 inline-flex items-center gap-2 px-8 py-4 bg-[#D98E2C] text-white rounded-xl font-semibold hover:bg-[#B5721B] transition-colors"
                >
                  Explore Services
        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold mt-5 text-slate-900">
                Voices from Our{" "}
                <span className="text-[#D98E2C]"> Trusted Partners</span>
              </h2>
            </motion.div>
        ...
        <section className="relative py-24 bg-[#0B1E33] overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-6 text-center text-white">
            ...
            <p className="text-lg mb-10 text-slate-300">
              Talk to our team about export, import, trading, or postal
